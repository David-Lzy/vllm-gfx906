...
- [Qwen3.5 35B-A3B expert-parallelism evaluation](phase-90-qwen35-moe-ep-v027.md)
- [Community GDN HIP source screen](phase-159-community-gdn-hip-screen.md)
...
- [Qwen serving topology shootout](phase-147-serving-topology-shootout.md)
...
- [Qwen3.5 v0.28 backend real-load A/B](phase-168-qwen35-v028-real-load-backend.md)
